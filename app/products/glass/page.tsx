...
const HERO_BADGES = [
  { icon: "✨", label: "Excellent Adhesion" },
  { icon: "🛡️", label: "Scratch Resistant" },
  { icon: "☀️", label: "UV Resistant" },
  { icon: "⚗️", label: "Chemical Resistant" },
  { icon: "💎", label: "Crystal Clear Finish" },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden min-h-[420px]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          >
            ...
            <p className="text-stone-600 text-[20px] leading-relaxed mb-6 max-w-md">
              High-performance industrial coatings engineered to enhance beauty,
              protect and extend the life of glass and plastic across demanding
              environments.
            </p>
      ...
      <section ref={sectionRef} className="bg-[#f8f9fa] py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Our Glass & Plastic Coating Solutions
            </h2>
            <p className="text-stone-500 text-[16px]">
              Specialized chemistries for superior performance and stunning
              finishes.
            </p>
          </motion.div>
      ...
      <section className="bg-white pb-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            Why Choose Krishna Coatings?
          </h3>
          <div className="flex items-center justify-between gap-4 px-4 py-4 bg-stone-50 border border-stone-200 rounded-2xl">
            {[
              {
                icon: "🔬",
                title: "Advanced R&D",
                desc: "Innovative formulations for specialized surfaces",
              },
              {
                icon: "💪",
                title: "Strong Adhesion Technology",
                desc: "Engineered for non-porous substrates",
              },
              {
                icon: "✅",
                title: "Consistent Quality",
                desc: "Stringent quality control at every step",
              },
              {
                icon: "🚛",
              ...
              },
              {
                ...
                desc: "Expert assistance for best performance",
              },
            ].map((b, i) => (
              <div key={i} className="flex items-center gap-2.5">
                <div className="w-10 h-10 rounded-full bg-white border border-stone-200 flex items-center justify-center text-base shadow-sm shrink-0">
                  {b.icon}
                </div>
                <div>
                  ...
                  <p className="text-[12px] text-stone-400">{b.desc}</p>
                </div>
                {i < 4 && (
                  <span className="hidden lg:block w-px h-8 bg-stone-200 ml-3" />
                )}
              </div>
            ))}
          </div>
  ...
  return (
    ...
    >
      <div className="relative h-44 overflow-hidden">
        <img
          src={product.image || "/coating/glass-coating.jpeg"}
          alt={product.name}
      ...
      <div className="px-4 pt-6 pb-5 flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between mt-auto pt-3 border-t border-stone-100">
          <Link
            href={`/products/glass/${product.id}`}
