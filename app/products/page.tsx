...
const CATEGORIES = [
  ...
  },
  {
    ...
    description:
      "Effective paint removers as per substrate for wood, metal, and glass surfaces.",
    href: "/products/paint-removers",
    image: "/paint-images/images/4.jpg",
    color: "#dc2626",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5" stroke="currentColor" strokeWidth={1.8}>
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#f7f8fa] py-14 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-4">
