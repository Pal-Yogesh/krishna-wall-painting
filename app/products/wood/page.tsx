...
const HERO_BADGES = [
  { icon: "✨", label: "Premium Appearance" },
  { icon: "🛡️", label: "Long-lasting Protection" },
  { icon: "🏭", label: "Industrial Performance" },
  { icon: "🔬", label: "Expert Technical Support" },
];

export default function WoodProductsPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden min-h-[420px]">
        ...
        <div className="absolute inset-0">
          <img
            src="/new-images/banner-wood.jpeg"
            alt="Wood Coatings"
            className="w-full h-full object-cover"
          />
        </div>

        <div className="relative max-w-7xl mx-auto px-2  py-14">
          <motion.div
          ...
          >
            ...
            >
              ...
              <br />
              <span style={{ color: ORANGE }}>For Every Application</span>
            </h1>
            <p className="text-stone-600 text-[20px] leading-relaxed mb-6 max-w-md">
              High-performance coating systems engineered to enhance beauty,
              protect and extend the life of wood.
            </p>

            {/* Feature badges */}
            <div className="grid grid-cols-2 max-w-lg gap-3 mb-8">
              {HERO_BADGES.map((b, i) => (
                <div
                  key={i}
      ...
      <section ref={sectionRef} className="bg-[#f8f9fa] py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Our Wood Coating Chemistries
            </h2>
            <p className="text-stone-500 text-[19px]">
              Advanced formulations for superior performance and perfect
              finishes.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
            {woodProducts.slice(0, 4).map((product, i) => (
              <ProductCard
                key={product.id}
                product={product}
                index={i}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {woodProducts.slice(4, 7).map((product, i) => (
              <ProductCard
                key={product.id}
                product={product}
                index={i + 4}
