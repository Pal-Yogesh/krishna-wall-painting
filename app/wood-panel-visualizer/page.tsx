...
const METAL_PANELS = [
  ...
  { id: 6,  name: "Bronze",            image: "/metal-panels/bronze-pvd.png",            cover: "/cover-photos/bronze-pvd.jpg",           color: "#7A5C2E" },
  { id: 7,  name: "Champagne Gold",    image: "/metal-panels/champagne-gold-pvd.png",    cover: "/cover-photos/champagne-gold-pvd.jpg",   color: "#D4AF6A" },
  { id: 8,  name: "Copper",            image: "/metal-panels/copper-pvd.png",            cover: "/cover-photos/copper-pvd.jpg",           color: "#B87333" },
  { id: 9,  name: "Emerald Green",     image: "/metal-panels/emerald-green-pvd.png",     cover: "/cover-photos/emerald-green-pvd.jpg",    color: "#2E8B57" },
  { id: 10, name: "Gunmetal Grey",     image: "/metal-panels/gunmetal-grey-pvd.png",     cover: "/cover-photos/gunmetal-grey-pvd.jpg",    color: "#4A4A4A" },
  { id: 11, name: "Matte Black",       image: "/metal-panels/matte-black-pvd.png",       cover: "/cover-photos/matte-black-pvd.jpg",      color: "#1A1A1A" },
  ...
  { id: 13, name: "Rose Gold",         image: "/metal-panels/rose-gold-pvd.png",         cover: "/cover-photos/rose-gold-pvd.jpg",        color: "#B76E79" },
  { id: 14, name: "Royal Blue",        image: "/metal-panels/royal-blue-pvd.png",        cover: "/cover-photos/royal-blue-pvd.jpg",       color: "#1E3A8A" },
  { id: 15, name: "Titanium Silver",   image: "/metal-panels/titanium-silver-pvd.png",   cover: "/cover-photos/titanium-silver-pvd.jpg",  color: "#A8A9AD" },
];
