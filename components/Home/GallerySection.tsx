...
const GALLERY_ITEMS = [
  ...
  { category: "Mr. Ashok Arora ", title: "Chairman", color: "#d97706", gradient: "linear-gradient(135deg, #16a34a20, #15803d40)", image: "https://res.cloudinary.com/dxfkygu6e/image/upload/v1780426454/kmopl-gallery/vdbibnxl8wj3q7wrz8ct.jpg" },
  ...
  { category: "Manufacturing Plant", title: "KMOPL Building", color: "#d97706", gradient: "linear-gradient(135deg, #7c3aed20, #6d28d940)", image: "https://res.cloudinary.com/dxfkygu6e/image/upload/v1780426446/kmopl-gallery/kwuwjyjy3iclquyb4mz4.jpg" },
  ...
  { category: "Product Team", title: "Team", color: "#d97706", gradient: "linear-gradient(135deg, #0891b220, #06748540)", image: "https://res.cloudinary.com/dxfkygu6e/image/upload/v1780426461/kmopl-gallery/wtlufvbueql2f6fzqxsn.jpg" },
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden group h-full">
      ...
      <div className="absolute bottom-4 left-4">
        <span className="text-[1rem] font-bold uppercase tracking-wider block mb-1" style={{ color: item.color }}>{item.category}</span>
        <span className="text-[12px] font-bold text-white " style={{ fontFamily: "var(--font-raleway), sans-serif" }}>{item.title}</span>
      </div>
    </div>
  );
}
