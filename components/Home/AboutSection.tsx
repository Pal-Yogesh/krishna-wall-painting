        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8 items-start">
          ...
          <div>
            ...
            <motion.div
              ...
              className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8 mt-[17%]"
            >
              {STATS.map((stat, i) => (
                <div
                  key={i}
                  className="flex flex-col items-center gap-2 p-4 bg-white border border-stone-200 rounded-2xl text-center shadow-sm"
                >
                  <span style={{ color: stat.color }}>{stat.icon}</span>
                  <span
                    className="text-4xl font-extrabold leading-none"
                    style={{ fontFamily: "var(--font-raleway), sans-serif", color: stat.color }}
                  >
                    {stat.value}
                  </span>
                  <span className="text-[11px] font-bold uppercase tracking-wider text-stone-500 leading-tight">
                    {stat.label}
                  </span>
                </div>
              ))}
