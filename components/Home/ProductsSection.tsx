      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col justify-center px-8 sm:px-12 py-12 bg-white z-10">
            {/* Eyebrow */}
            <p
              className="text-[11px] font-extrabold uppercase tracking-[0.22em] mb-3"
              style={{ color: GOLD }}
            >
            ...
            <div
              className="w-8 h-0.5 mt-4 mb-6 rounded-full"
              style={{ background: GOLD }}
            />

            <p className="text-stone-500 text-[14px] leading-relaxed mb-9 max-w-xs">
              Our advanced manufacturing facility and robust quality systems
              ensure consistent quality in every batch.
            </p>
          ...
          <div className="relative hidden lg:block overflow-hidden">
            ...
            >
              <img
                src="/new-images-update/manufacturing-excelllence.png"
            ...
            >
              ...
              <p className="text-white/85 text-[12px] font-medium tracking-wide">
                Modern Infrastructure &nbsp;•&nbsp; Advanced Technology
                &nbsp;•&nbsp; Consistent Quality
              </p>
            </div>
          </div>
        ...
        <div className="bg-[#f4f5f7] px-5 pb-5 rounded-xl">
          {/* ── 3 FEATURE CARDS ── */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-3 ">
            {FEATURES.map((f, i) => (
              <motion.div
                ...
                className="flex items-start gap-4 px-6 py-6  overflow-hidden"
              >
                {/* Navy circle icon */}
                <div
          ...
          <motion.div
            ...
            className="mt-3 flex flex-col sm:flex-row items-center justify-between gap-4 px-6 sm:px-8 py-5 bg-[#d0d4dab8] rounded-xl"
          >
            <div className="flex items-center gap-4">
              ...
              <p
                className="text-[14px] font-semibold text-stone-800 max-w-sm"
            ...
            <div className="hidden sm:block w-px h-10 bg-stone-600 shrink-0" />
            <Link
              href="/about"
