        ...
        <div className="overflow-hidden">
          ...
          {doubledLogos.map((logo, i) => (
            <motion.div
              ...
              className="shrink-0 w-40 h-24 bg-white border border-stone-200/80 rounded-xl shadow-sm flex items-center justify-center p-3 hover:shadow-md hover:border-amber-200 cursor-pointer"
            >
              <Image
                src={logo.src}
                alt={logo.alt}
